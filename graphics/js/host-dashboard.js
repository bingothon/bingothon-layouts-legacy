...
$(() => {
	...
	var stcText = ['Everyday more than 16,000 children die before reaching their 5th birthday, mostly from preventable and treatable causes. An Example of such cause is diarrhea which is one of the top killers of children under 5 globally. It only takes $1 dollar to provide one person with treatment against diarrhea. $1 dollar between life and death. If you’d like to make a contribution you can do so by typing !donate in the chat and following the instructions.', 'Save the Children is one of the most efficient and effective charities in the world, independently rated by charity watchdogs, and one of the few that focus on children.<br><br>Save the Children believes that:<br><br>1. No child should die from preventable causes<br><br>2. All children should have access to a quality basic education and <br><br>3. No child should be a victim of violence. Save the Children works every day and in times of crisis to ensure that these three goals are achieved.<br><br>When the worst happens, children are always among the most vulnerable – and often suffer most. Save the Children responds to natural disasters, conflicts and other humanitarian emergencies across the globe with health, education and protection programs that address the unique needs of children in crisis.', '263 million children are out of school - that’s more than 1 in 6 school-aged children. Educating children gives the next generation the tools to fight poverty and prevent disease. It builds confidence, literacy and dignity. It builds a stronger foundation for the future we all share. And it’s every child’s right. A small contribution of $5 dollars can provide education supplies for one child, giving him/her the tools they need to continue their education.  In 2016, Save the Children helped over 13 million children through their education programs. You can give today by typing !donate in the chat and following the instructions! Thank you.', '168 million children worldwide are involved in child labor - that’s more than all the children in Europe combined. Child labour deprives children the right to normal physical and mental development and often interferes with children’s education. $50 can pay for the attendance of an entire village school in a country like Uganda, including the cost of teacher training and salary, supplies, and curriculum. Educating children gives the next generation the tools to fight poverty and prevent disease. If you’d like to make a contribution you can do so by typing !donate in the chat and following the instructions. Thank you kindly.', 'Globally, one girl under 15 gets married every seven seconds and every two seconds a child gives birth. Childbearing at a young age, when a girl’s body is not physically mature enough to deliver without complications, often leads to devastating consequences. Complications from pregnancy and childbirth are the second leading cause of death for girls. Child brides are often isolated, with their freedom curtailed. They frequently feel disempowered and are deprived of their rights to health, education and safety. Early childbearing also severely impacts the economies of communities and nations. For example, if all adolescent girls in Kenya completed secondary school, and if more than 200,000 adolescent mothers there were employed instead of having become pregnant, $3.4 billion could have been added to the economy. This is equivalent to the value of Kenya’s entire construction sector. You can make a positive change by making a contribution today helping Save the Children protect kids from child-pregnancies and child-marriage.', 'Save the Children was founded nearly 100 years ago and today works in 120 countries. Known to be one of the most efficient and effective charities in the world and one of a few that focus on children. Last year Save the Children helped more than 157 million children around the globe. Thank you all for donating.', 'Save the Children works in the heart of communities, where they help children and families help themselves. By providing education, infrastructure, healthcare and protection from harm. Save the Children works closely with other organizations, governments, non-profits and a variety of local partners while maintaining their own independence without political agenda or religious orientation. Help us, help them, in making the world a better place. Thank you all for donating.', 'Your donations go towards Save the Children and their mission in giving children a healthy start in life, the opportunity to learn and protection from harm. Thank you watching and supporting.'];
